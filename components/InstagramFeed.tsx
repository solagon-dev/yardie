      ...
      <div className="relative mx-auto max-w-2xl text-center px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-7 sm:mt-9 flex justify-center">
          <a
            ...
            className="group inline-flex items-center justify-center gap-3 text-[11px] font-medium text-bark hover:text-moss transition-colors px-5 py-3 bg-cream-alt border border-border hover:border-moss/40"
          >
