...
export default function BeforeAfterSlider({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className={`absolute top-4 left-4 sm:top-6 sm:left-6 inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-cream/95 text-bark text-[10.5px] font-medium transition-opacity duration-300 ${
 pos > 6 ? "opacity-100" : "opacity-0"
      ...
      <span
        aria-hidden
        className={`absolute top-4 right-4 sm:top-6 sm:right-6 inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-cream/95 text-bark text-[10.5px] font-medium transition-opacity duration-300 ${
